...
I built a reinforcement learning agent (Monkey) that learns to choose between two identical taps: One containing sugar war and the other plain water. The Monkey learns purely from trial and error.
